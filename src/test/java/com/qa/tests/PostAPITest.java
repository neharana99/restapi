...
public class PostAPITest extends TestBase{
	...
	public void postAPITest() throws JsonGenerationException, JsonMappingException, IOException{
		...
		//jackson API:
		 ...
		 // object to json file: 
			  mapper.writeValue(new File("C:/Users/nrana12/eclipse-workspace/RESTAPI1/src/main/java/com/qa/data/users.json"), users);
		  ...
		  //actual users object System.out.println(usersResObj);
